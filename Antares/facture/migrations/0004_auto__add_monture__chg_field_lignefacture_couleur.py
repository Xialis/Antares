...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Monture'
        db.create_table('facture_monture', (
        ...
        db.send_create_signal('facture', ['Monture'])


        # Changing field 'LigneFacture.couleur'
        db.alter_column('facture_lignefacture', 'couleur_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['fournisseur.Couleur']))

    def backwards(self, orm):
        # Deleting model 'Monture'
        db.delete_table('facture_monture')


        # Changing field 'LigneFacture.couleur'
        db.alter_column('facture_lignefacture', 'couleur_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fournisseur.Couleur'], null=True))
