...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('facture_facture', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('numero', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12)),
            ...
            ('prescription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['client.Prescription'])),
            ('bproforma', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('proforma', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facture.Facture'], null=True, blank=True)),
            ('interloculteur', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facture.Interlocuteur'])),
        ))
        db.send_create_signal('facture', ['Facture'])

        # Adding model 'LigneFacture'
        db.create_table('facture_lignefacture', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facture.Facture'])),
            ('monture', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('oeil', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ...
            ('couleur', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fournisseur.Couleur'])),
            ('traitement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fournisseur.Traitement'])),
            ('tarif', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=0)),
        ))
        db.send_create_signal('facture', ['LigneFacture'])

        # Adding model 'Option'
        db.create_table('facture_option', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facture.Facture'])),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('tarif', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=0)),
        ))
        db.send_create_signal('facture', ['Option'])

        # Adding model 'Interlocuteur'
        db.create_table('facture_interlocuteur', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25)),
        ))
        db.send_create_signal('facture', ['Interlocuteur'])


    def backwards(self, orm):
        # Deleting model 'Facture'
        db.delete_table('facture_facture')

        # Deleting model 'LigneFacture'
        db.delete_table('facture_lignefacture')

        # Deleting model 'Option'
        db.delete_table('facture_option')

        # Deleting model 'Interlocuteur'
        db.delete_table('facture_interlocuteur')
    ...
    models = {
        ...
        'facture.lignefacture': {
            ...
            'traitement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fournisseur.Traitement']"}),
