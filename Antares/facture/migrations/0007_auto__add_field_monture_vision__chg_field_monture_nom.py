...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Monture.vision'
        db.add_column('facture_monture', 'vision',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=1),
                      keep_default=False)


        # Changing field 'Monture.nom'
        db.alter_column('facture_monture', 'nom', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'Monture.vision'
        db.delete_column('facture_monture', 'vision')


        # User chose to not deal with backwards NULL issues for 'Monture.nom'
        raise RuntimeError("Cannot reverse this migration. 'Monture.nom' and its values cannot be restored.")
    ...
    models = {
        ...
        'facture.monture': {
            ...
            'tarif': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '0'}),
