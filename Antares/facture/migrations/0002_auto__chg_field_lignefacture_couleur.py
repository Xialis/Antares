...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LigneFacture.couleur'
        raise RuntimeError("Cannot reverse this migration. 'LigneFacture.couleur' and its values cannot be restored.")
