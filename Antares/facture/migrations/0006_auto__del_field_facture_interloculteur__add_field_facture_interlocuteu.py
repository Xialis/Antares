...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Facture.interloculteur'
        db.delete_column('facture_facture', 'interloculteur_id')

        # Adding field 'Facture.interlocuteur'
        db.add_column('facture_facture', 'interlocuteur',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['facture.Interlocuteur']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Facture.interloculteur'
        raise RuntimeError("Cannot reverse this migration. 'Facture.interloculteur' and its values cannot be restored.")
        # Deleting field 'Facture.interlocuteur'
        db.delete_column('facture_facture', 'interlocuteur_id')
