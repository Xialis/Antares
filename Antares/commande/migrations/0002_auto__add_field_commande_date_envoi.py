...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commande.date_envoi'
        db.add_column('commande_commande', 'date_envoi',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commande.date_envoi'
        db.delete_column('commande_commande', 'date_envoi')
