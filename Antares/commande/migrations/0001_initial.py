...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('commande_commande', (
        ...
        db.send_create_signal('commande', ['Commande'])

        # Adding model 'LigneCommande'
        db.create_table('commande_lignecommande', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('commande', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['commande.Commande'])),
            ('ligne_facture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facture.LigneFacture'], null=True, blank=True)),
            ('ligne_stock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stock.LigneStock'], null=True, blank=True)),
            ('quantite', self.gf('django.db.models.fields.IntegerField')()),
            ('quantite_recu', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('commande', ['LigneCommande'])


    def backwards(self, orm):
        # Deleting model 'Commande'
        db.delete_table('commande_commande')

        # Deleting model 'LigneCommande'
        db.delete_table('commande_lignecommande')
    ...
    models = {
        ...
        'commande.lignecommande': {
            ...
            'quantite_recu': ('django.db.models.fields.IntegerField', [], {})
        },
        'facture.facture': {
