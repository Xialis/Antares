...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Commande', fields ['numero']
        db.delete_unique('commande_commande', ['numero'])


    def backwards(self, orm):
        # Adding unique constraint on 'Commande', fields ['numero']
        db.create_unique('commande_commande', ['numero'])
