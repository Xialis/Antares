...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commande.date_cloture'
        db.add_column('commande_commande', 'date_cloture',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commande.date_cloture'
        db.delete_column('commande_commande', 'date_cloture')
