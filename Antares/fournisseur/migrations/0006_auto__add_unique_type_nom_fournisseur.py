...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Type', fields ['nom', 'fournisseur']
        db.create_unique('fournisseur_type', ['nom', 'fournisseur_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Type', fields ['nom', 'fournisseur']
        db.delete_unique('fournisseur_type', ['nom', 'fournisseur_id'])
