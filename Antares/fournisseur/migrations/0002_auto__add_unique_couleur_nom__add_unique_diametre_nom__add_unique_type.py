...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Fournisseur', fields ['nom']
        db.create_unique('fournisseur_fournisseur', ['nom'])


    def backwards(self, orm):
        # Removing unique constraint on 'Fournisseur', fields ['nom']
        db.delete_unique('fournisseur_fournisseur', ['nom'])
    ...
    models = {
        'fournisseur.couleur': {
            ...
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'})
        },
        'fournisseur.diametre': {
            'Meta': {'object_name': 'Diametre'},
            'fournisseur': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fournisseur.Fournisseur']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'})
        },
