...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Couleur', fields ['nom', 'fournisseur']
        db.create_unique('fournisseur_couleur', ['nom', 'fournisseur_id'])

        # Adding unique constraint on 'Diametre', fields ['nom', 'fournisseur']
        db.create_unique('fournisseur_diametre', ['nom', 'fournisseur_id'])

        # Adding unique constraint on 'Traitement', fields ['nom', 'fournisseur']
        db.create_unique('fournisseur_traitement', ['nom', 'fournisseur_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Traitement', fields ['nom', 'fournisseur']
        db.delete_unique('fournisseur_traitement', ['nom', 'fournisseur_id'])

        # Removing unique constraint on 'Diametre', fields ['nom', 'fournisseur']
        db.delete_unique('fournisseur_diametre', ['nom', 'fournisseur_id'])

        # Removing unique constraint on 'Couleur', fields ['nom', 'fournisseur']
        db.delete_unique('fournisseur_couleur', ['nom', 'fournisseur_id'])
